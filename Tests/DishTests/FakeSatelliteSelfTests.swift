...
private let ds4Descriptor: [String: Any] = [
    "ctrlIdx": 0,
    "type": 1,
...
// MARK: - Harness fidelity vs the real satellite (fix-wave 2026-07-20)

/// Pins the places where the harness used to be MORE LENIENT than
/// `routes_client.cpp` / `session_service.cpp` / `receiver.cpp` — leniency
/// here lets client regressions stay green.
